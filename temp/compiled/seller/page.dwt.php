...
<div id="turn-page">
    <div class="pagination">
        <ul>
            ...
            <?php $_from = $this->_var['page_count_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'page_count_0_69961100_1541229649');$this->_foreach['pageCount'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['pageCount']['total'] > 0):
    foreach ($_from AS $this->_var['page_count_0_69961100_1541229649']):
        $this->_foreach['pageCount']['iteration']++;
?>
            <?php if ($this->_var['page_count_0_69961100_1541229649'] == $this->_var['filter']['page']): ?>
                <li><span class="currentpage"><?php echo $this->_var['page_count_0_69961100_1541229649']; ?></span></li>
            <?php else: ?>
                <li><a href="javascript:listTable.gotoPage(<?php echo $this->_var['page_count_0_69961100_1541229649']; ?>)"><span><?php echo $this->_var['page_count_0_69961100_1541229649']; ?></span></a></li>
            <?php endif; ?>
