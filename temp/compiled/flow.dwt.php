                                ...
                                <div class="item_value" ectype="regionLinkage">
                                    <dl class="mod-select mod-select-small" ectype="smartdropdown" id="selProvinces">
                                        ...
                                        <dd ectype="layer">
                                            ...
                                            <?php $_from = $this->_var['provinces']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_83424000_1542095539');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_83424000_1542095539']):
?>
                                            <div class="option" data-value="<?php echo $this->_var['province_0_83424000_1542095539']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_83424000_1542095539']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_83424000_1542095539']['region_name']; ?></div>
                                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                        </dd>
                                    </dl>
