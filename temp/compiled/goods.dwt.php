...
?>
                                ...
                                <dl class="goods-para">
                                    <?php $_from = $this->_var['extend_info']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'info_0_09696300_1542090660');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['info_0_09696300_1542090660']):
?>
                                    <dd class="column"><span title="<?php echo htmlspecialchars($this->_var['info_0_09696300_1542090660']); ?>"><?php echo $this->_var['key']; ?>：<?php echo htmlspecialchars($this->_var['info_0_09696300_1542090660']); ?></span></dd>
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                </dl>
                                <?php endif; ?>
                                <?php if ($this->_var['properties']): ?>
