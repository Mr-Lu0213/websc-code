...
?>
                                ...
                                <div class="imitate_select w90">
                                    ...
                                    <ul>
                                        <?php $_from = $this->_var['select_date']['day']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_46015600_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_46015600_1542090647']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_46015600_1542090647']; ?>"><?php echo $this->_var['data_0_46015600_1542090647']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
                            ...
                            <div class="value">
                                <div class="imitate_select w200">
                                    ...
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['passwd_questions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_46030800_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_46030800_1542090647']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_46030800_1542090647']; ?>"><?php echo $this->_var['data_0_46030800_1542090647']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
...
?>
                            ...
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                ...
                                <dd ectype="layer">
                                    ...
                                    <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_46436400_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_46436400_1542090647']):
?>
                                    <div class="option" data-value="<?php echo $this->_var['province_0_46436400_1542090647']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_46436400_1542090647']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_46436400_1542090647']['region_name']; ?></div>
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                </dd>
                            </dl>
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_46524000_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_46524000_1542090647']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_46524000_1542090647']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_46524000_1542090647']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_46524000_1542090647']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
								...
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
									...
									<dd ectype="layer">
										<div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
										<?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_46559700_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_46559700_1542090647']):
?>
										<div class="option" data-value="<?php echo $this->_var['province_0_46559700_1542090647']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_46559700_1542090647']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_46559700_1542090647']['region_name']; ?></div>
										<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
									</dd>
								</dl>
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                                ...
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_46983500_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_46983500_1542090647']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_46983500_1542090647']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_46983500_1542090647']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_46983500_1542090647']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
...
?>
                                ...
                                <div class="list-div" id="detailCategoryTable">
                                    <table class="m-table mt20" >
                                        ...
                                        <tbody>
                                        <?php $_from = $this->_var['category_info']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'category_0_46990900_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['category_0_46990900_1542090647']):
?>
                                            <tr>
                                                <td align="center">
                                                    <p>
                                                        <span class="index"><?php echo $this->_var['k']; ?></span>
                                                        <input type="hidden" value="<?php echo $this->_var['category_0_46990900_1542090647']['cat_id']; ?>" name="cat_id[]" class="cId">
                                                    </p>
                                                </td>
                                                <td align="center" >
                                                    <p>
                                                        <input type="hidden" value="<?php echo $this->_var['category_0_46990900_1542090647']['parent_name']; ?>" name="parent_name[]" class="cl1Name">
                                                        <?php echo $this->_var['category_0_46990900_1542090647']['parent_name']; ?>
                                                    </p>
                                                </td>
                                                <td align="center">
                                                    <p>
                                                        <input type="hidden" value="<?php echo $this->_var['category_0_46990900_1542090647']['cat_name']; ?>" name="cat_name[]" class="cl2Name">
                                                        <?php echo $this->_var['category_0_46990900_1542090647']['cat_name']; ?>
                                                    </p>
                                                </td>
                                                <td><div class="tDiv"><a class="btn_trash" href="javascript:void(0);" onClick="deleteChildCate(<?php echo $this->_var['category_0_46990900_1542090647']['ct_id']; ?>)"><i class="icon icon-trash"></i><?php echo $this->_var['lang']['drop']; ?></a></div></td>
                                            </tr>
                                        <?php endforeach; else: ?>
...
?>
                                ...
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_47027600_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_47027600_1542090647']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_47027600_1542090647']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_47027600_1542090647']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_47027600_1542090647']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_47125200_1542090647');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_47125200_1542090647']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_47125200_1542090647']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_47125200_1542090647']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_47125200_1542090647']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
